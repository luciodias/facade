...
public class TestBebida {
    ...
    public void testGetNome() {
        ...
        // Assert
        assertEquals(expectedNome, actualNome, "The name of the bebida should match the expected value.");
    }
    ...
    public void testGetPreco() {
        ...
        // Assert
        assertEquals(expectedPreco, actualPreco, "The price of the bebida should match the expected value.");
    }
